...
const ShoppingCart = () => {
  ...
  const { cart, handleChange, cartRemoveItem, price, clearCartFunc } =
        ...
        <div className="container mx-auto sm:px-10 px-2 py-16">
          <div className="flex flex-col gap-16">
            ...
            {cart.length > 0 ? (
              <div>
                <div>
                  ...
                  <div className="flex justify-end">
                    <button
                      className="bg-red-600 mt-16 py-2 px-12 border-none outline-none text-white text-[18px] tracking-[1.5px] rounded-lg transition duration-200 opacity-80 hover:opacity-100"
                ...
                <div className="mt-16 flex justify-between items-end flex-wrap gap-x-6 gap-y-9">
                  ...
                  <div className="flex flex-col gap-6 mb-6">
                    <div className="flex flex-col gap-3">
                      <h3 className="sm:text-[24px] text-[20px] font-Montserrat">
                        Subtotal: <span className="font-bold">{price} Azn</span>
                      </h3>
                    ...
                    <div>
                      <button
                        onClick={() => alert("Sifarişiniz Uğurla Göndərildi !")}
                        className="bg-heroText py-2 px-12 border-none outline-none text-white text-[18px] tracking-[1.5px] rounded-lg transition duration-200 opacity-80 hover:opacity-100"
                      >
                        Gonder
                      </button>
                    </div>
              ...
              <h1 className="font-Montserrat font-bold text-red-500 text-center sm:text-[36px] text-[27px]">
                Hec Bir Məhsul Yoxdur !
              </h1>
            )}
          </div>
        </div>
