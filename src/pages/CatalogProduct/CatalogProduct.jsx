          ...
          <div className="flex cr:flex-row flex-col gap-x-16 gap-y-16 justify-between items-center">
            ...
            <div className="flex flex-col cr:items-start items-center gap-5">
              ...
              <h3 className="sm:text-[24px] text-[20px] cr:text-start text-center">
                Metrolara çatdırılma{" "}
                <span className="font-bold">pulsuzdur.</span> Ancaq normalda
                çatdırılmanın qiymeti{" "}
              ...
              <div className="flex gap-6 rd:flex-row flex-col items-center gap-y-7">
                <button
                  ...
                  className="rd:w-[180px] w-[240px] bg-heroText py-3 px-4 border-none outline-none text-white sm:text-[18px] text-[16px] tracking-[1.5px] rounded-lg transition duration-200 opacity-80 hover:opacity-100"
                >
                  Səbətə əlavə et
                </button>
                <Link to={"/catalog"}>
