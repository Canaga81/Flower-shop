...
const Navbar = () => {
  ...
  return (
    <div className="w-full h-full bg-white sticky top-0 z-40">
      <div className="container mx-auto">
        <div className="flex items-center justify-between pl-24 pr-24">
          ...
          <div className="flex justify-between items-center gap-6">
            <div className="w-[45px] h-[45px] flex justify-center items-center rounded-[5px] shadow-lg cursor-pointer pt-2">
              <IoIosSearch />
            </div>
